...
mySchool.student("Khushal Vaghasiya", "khushal@vaghasiya.com", "1234567890");
mySchool.faculty("Vishal Solanki", "vishal@solanki.com", "0987654321");
...
const emp = new Employee("khushal", 20);
emp.printDetails();
...
myShape.circleArea(5); 
myShape.rectangleArea(10, 20); 
